...
const productionRequiredGroups = [
    {
        name: 'AI providers',
        keys: [
            'GROQ_API_KEY',
...
const optionalNonProductionGroups = [
    {
...
const validateCorsOrigins = (origins) => origins
    .split(',')
...
const collectMissing = (keys) => keys.filter((key) => { var _a; return !((_a = process.env[key]) === null || _a === void 0 ? void 0 : _a.trim()); });
function failConfiguration(errors) {
