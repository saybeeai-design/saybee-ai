    ...
    <div className="min-h-screen flex items-center justify-center p-4 gradient-bg relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] relative z-10 py-12">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-white mt-4 text-center leading-tight">Create your account</h1>
          <p className="text-[#8888aa] mt-2">Start practicing interviews with AI today</p>
        </div>

        <div className="glass-card p-8 shadow-2xl rounded-2xl border border-white/10 backdrop-blur-xl">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium mb-2 text-[#8888aa]">Full Name</label>
              <div className="relative group">
                <User className="absolute left-3.5 top-3.5 w-[18px] h-[18px] text-[#8888aa] group-focus-within:text-[#6c63ff] transition-colors" />
                <input
                  type="text"
          ...
          <p className="mt-8 text-center text-sm text-[#8888aa]">
            ...
            <Link href="/login" className="font-semibold text-[#6c63ff] hover:text-[#8179ff] transition-colors">
              Sign in
            </Link>
          </p>
        </div>
